        ...
        return MaterialApp(
          ...
          theme: ThemeData(
            ...
            colorScheme: ColorScheme(
              ...
              primaryContainer: const Color.fromARGB(255, 86, 207,
                  171), // Contenedor del primario (ej. DrawerHeader)
              onPrimaryContainer: const Color.fromARGB(
                  255, 32, 21, 0), // Texto sobre el contenedor primario
              secondary:
                  const Color(0xFF4A635F), // Color secundario para acentos
              onSecondary: Colors.white, // Texto sobre el secundario
              surface: const Color.fromARGB(
                  255, 237, 238, 237), // Color de fondo para Cards, Dialogs
            ...
            scaffoldBackgroundColor: const Color.fromARGB(
                255, 212, 226, 223), // Color de fondo general de la app
